...
export const changePassword = (currentPassword, newPassword) => api.put(`/api/users/change-password`, { currentPassword, newPassword });
...
export const createArtist = (artistData) => api.post(`/api/artists`, artistData);
export const getArtistProfile = () => api.get(`/api/artists/profile`);
export const updateArtistProfile = (artistData) => api.put(`/api/artists/profile`, artistData);
export const deleteArtistProfile = () => api.delete(`/api/artists/profile`);
export const getArtistById = (id) => api.get(`/api/artists/${id}`);
export const updateArtist = (id, artistData) => api.put(`/api/artists/${id}`, artistData);
...
export const adminUpdateArtist = (id, artistData) => api.put(`/api/admin/artists/${id}`, artistData);
export const adminDeleteArtist = (id) => api.delete(`/api/admin/artists/${id}`);

export const getAllEvents = () => api.get(`/api/admin/events`);
export const adminUpdateEvent = (id, eventData) => api.put(`/api/admin/events/${id}`, eventData);
export const adminDeleteEvent = (id) => api.delete(`/api/admin/events/${id}`);

// Event Hosts 
export const getEventHosts = () => api.get(`/api/event-hosts`);
export const createEventHost = (eventHostData) => api.post(`/api/event-hosts`, eventHostData);
export const getEventHostProfile = () => api.get(`/api/event-hosts/profile`);
export const updateEventHostProfile = (eventHostData) => api.put(`/api/event-hosts/profile`, eventHostData);
export const deleteEventHostProfile = () => api.delete(`/api/event-hosts/profile`);
export const getEventHostById = (id) => api.get(`/api/event-hosts/${id}`);
export const updateEventHost = (id, eventHostData) => api.put(`/api/event-hosts/${id}`, eventHostData);
...
export const adminUpdateEventHost = (id, eventHostData) => api.put(`/api/admin/event-hosts/${id}`, eventHostData);
export const adminDeleteEventHost = (id) => api.delete(`/api/admin/event-hosts/${id}`);
